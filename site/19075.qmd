...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/19075_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/19075_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/19075_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/19075_ts.csv');
