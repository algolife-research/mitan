...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/87064_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/87064_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/87064_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/87064_ts.csv');
