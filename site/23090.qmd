...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/23090_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/23090_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/23090_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/23090_ts.csv');
