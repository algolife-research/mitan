...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/19261_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/19261_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/19261_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/19261_ts.csv');
