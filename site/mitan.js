...
(async function loadAndDisplayForetScore(csvUrl) {
  ...
  try {
    ...
    imgEl.style.width = "150px";  // Set the width to 80 pixels
    ...
    document.getElementById("foret-score-details").innerHTML = `
      ...
      <b>Surface de la commune :</b> ${surfaceTotal.toLocaleString()} ha<br>
      <b>Surface boisée :</b> ${surfaceBoisee.toLocaleString()} ha<br>
      <b>Taux de boisement :</b> ${tauxBoisement.toFixed(2)}%<br>
      <b>Taux de coupes :</b> ${coupesHa.toFixed(3)} ha/an
    `;
