...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/87183_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/87183_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/87183_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/87183_ts.csv');
