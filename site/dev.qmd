...
.on('markgeocode', function(e) {
    ...
    map.setView(latlng, 12); // Zoom to the selected location
    L.marker(latlng).addTo(map) // Add a marker at the found location
...
(async function() {
    ...
    // Add title "Couches" above the layer control
    ...
    // Insert the title before the layer list
