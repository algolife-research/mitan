---
title: "Saint-Yrieix-la-Montagne"
format: html
echo: false
warning: false
---
...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/23249_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/23249_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/23249_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/23249_ts.csv');
