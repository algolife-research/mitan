...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/23077_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/23077_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/23077_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/23077_ts.csv');
