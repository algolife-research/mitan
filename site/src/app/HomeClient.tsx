        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">
              Coupes rases, forêts et patrimoine naturel, commune par commune
            </h1>
          </div>
          ...
          <div className="text-lg text-gray-700 mb-12 space-y-4">
            ...
            <p>
              ...
              notamment les <strong>coupes rases</strong>, et <strong>espace d'échange</strong> pour citoyens
              et gestionnaires, favorisant des décisions éclairées pour l'avenir de nos <strong>territoires</strong>.
            </p>
          ...
          <div className="mb-10 text-center">
            <Link href="/carte-france" className="text-secondary hover:underline font-medium">
              → Voir la carte de France des coupes rases par département
            </Link>
          </div>
