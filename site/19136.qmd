...
(async function() {
    ...
    const aoiData = await loadGeoJSON('communes_results/19136_commune.geojson');
    ...
    const bdfData = await loadGeoJSON('communes_results/19136_bdforet.geojson');
    ...
    const geojsonData = await loadGeoJSON('communes_results/19136_cr_mask_pr.geojson');
    const csvData = await loadCSV('communes_results/19136_ts.csv');
